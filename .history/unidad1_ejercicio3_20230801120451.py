...
# This code is calculating the perimeter and area of a circumference based on the radius entered by
# the user. It uses the math module to access the value of pi and perform mathematical calculations.
